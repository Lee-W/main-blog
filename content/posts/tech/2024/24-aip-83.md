...
Subtitle: DAG 即將走入歷史
Date: 2024-11-19 19:30 +0800
Modified: 2024-11-19 21:20 +0800
Category: Tech
...
## TLDR
自從有了 `DagRun.run_id`，不需要 `execution_date` 來分辨 dag run 了
可以移除 `execution_date` 的 unique constraint
...
* `execution_date` needs to be removed in
