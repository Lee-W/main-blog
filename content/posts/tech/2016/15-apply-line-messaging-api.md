...
<!--more-->
![1_messaging_api](/images/post-images/2016-11-22-apply-line-messaging-api/3i3O1wO.png)
...
![2_price](/images/post-images/2016-11-22-apply-line-messaging-api/FmTjOBH.png)

再來會詢問業務類別，跟要求設定 Bot 名稱和照片
![3_apply_account](/images/post-images/2016-11-22-apply-line-messaging-api/VdCT8JX.png)

回到[Line Business Center](https://business.line.me/zh-hant/) 的帳號清單
就能看到帳號已經創好了
![4_success_apply](/images/post-images/2016-11-22-apply-line-messaging-api/4ViJbIR.png)
...
![5_bot_page](/images/post-images/2016-11-22-apply-line-messaging-api/8DC4TSG.png)

接著到設定頁面左下方，找到 `Settings`  → `Bot Settings`

進入以下的畫面開啟 Messaging API
![6_bot_setting](/images/post-images/2016-11-22-apply-line-messaging-api/BtaSwa5.png)
...
![7_bot_webhook](/images/post-images/2016-11-22-apply-line-messaging-api/yqpw3x7.png)

往下拉可以看到更多的選項
![8_bot_detail](/images/post-images/2016-11-22-apply-line-messaging-api/nKegbk6.png)
...
![9_finish_all_setting](/images/post-images/2016-11-22-apply-line-messaging-api/io9LuHs.png)

進到 `LINE Developers` 就能取得你的 Channel Secret 和 Channel Access Token 了
（這些都是運用 Line Messaging API 會用到的）

![10_line_developers_page](/images/post-images/2016-11-22-apply-line-messaging-api/cl8k3Mh.png)
