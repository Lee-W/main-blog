...
* Button
![button_example](/images/post-images/2016-11-27-more-about-line-messaging-api-template-messages/KYN6kDR.png)

* Confirm
![confirm_example](/images/post-images/2016-11-27-more-about-line-messaging-api-template-messages/pUFboL5.png)

* Carousel (如果超出版面，則可以左右滑動)
![carousel_example](/images/post-images/2016-11-27-more-about-line-messaging-api-template-messages/Pxvj6om.png)

另外必須要注意的是，這些功能目前都只支援手機版
在電腦版上的 Line 看到的訊息會是這樣
![template_message_on_pc](/images/post-images/2016-11-27-more-about-line-messaging-api-template-messages/ZdGQjc6.png)
...
![text_example](/images/post-images/2016-11-27-more-about-line-messaging-api-template-messages/ow2G8wU.png)
