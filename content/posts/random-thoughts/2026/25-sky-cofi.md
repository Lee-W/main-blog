...
細節可以在[官網](https://www.skycofi.com/)找到

原本我都是使用 CoWorker 方案的一日 540 元（原本好像是 480 元）
可以點心吃到飽，也可以喝限定種類的飲料喝到飽
對一天有辦法喝很多咖啡的人應該是偏划算
但我的單日咖啡因攝取量通常是一杯，最多到兩杯
所以後來都在喝國寶茶
雖然也是很好喝啦...但就覺得有更好的選擇

這幾次去有研究了一下低消方案
只要點到 290 元就可以使用 5 小時（或者 435 元全天）
以我現在的情境就很適合
早上先在家工作一下，通勤再推一點進度
...
不過這時候只要拿出我的[XM6]({filename}/posts/random-thoughts/2025/7-sony-wh-1000-xm6.md)就沒問題了 👌
