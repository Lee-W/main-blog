...
Posts are organized by category then year (e.g., `content/posts/tech/2026/`). Filenames are created without a numeric prefix locally; GitHub Actions assigns the final sequence number at publication time.
